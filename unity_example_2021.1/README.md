...
> A second copy of this example built against **Unity 2023.2** lives in
> `../unity_example_2023.2/` if you are on a newer Unity LTS. The two are
> functionally identical; pick whichever matches your local Unity install.
...
└── unity_project/                       # The Unity 2021.1 source project
    └── Assets/
...
The default admin credentials are at <http://localhost:5006/admin>
...
1. Open `unity_project/` in Unity 2021.1.
